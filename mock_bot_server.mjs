...
const BOT_HANDLERS = {
  ...
  "trivia-duel": (message, history) => {
    ...
    if (lower.includes("mars") || lower.includes("b.") || lower.includes("b")) {
      return {
        content:
          "🎉 **TEPAT SEKALI! (+100 Poin)**\nJawabannya adalah **B. Mars** (warna merah berasal dari besi oksida di permukaannya).\n\n---\n\n**Babak 2 (Sejarah & Komputer):**\n*Siapakah tokoh yang dikenal memecahkan kode mesin enkripsi Enigma pada Perang Dunia II?*",
        chips: ["Alan Turing", "Charles Babbage", "Ada Lovelace", "John von Neumann"],
      }
    } else if (lower.includes("turing")) {
      return {
        content:
          "🏆 **LUAR BIASA BENAR! (+100 Poin, Total: 200 Poin)**\n**Alan Turing** adalah bapak ilmu komputer teoritis dan pemecah sandi Enigma di Bletchley Park!\n\n---\n\n**Babak 3 (Geografi):**\n*Danau terdalam di dunia yang menampung 20% air tawar permukaan bumi adalah?*",
      ...
      return {
        ...
        chips: ["Sains & Antariksa", "Sejarah Dunia", "Teknologi & AI", "Pop Culture"],
      }
    }
  },
}
